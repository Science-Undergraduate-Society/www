...
export default function ElectionsTimeline() {
  return (
    <Timeline>
      ...
      <TimelineItem>
        <DateText>Friday, Sept 26th, 11:59 PM</DateText>
        <EventText>
      ...
      <TimelineItem>
        <DateText>Monday, Sept 29th, 12:00 AM</DateText>
        <EventText>Campaigning begins (paperless campaigning)</EventText>
      </TimelineItem>

      <TimelineItem>
        <DateText>Monday, Oct 6th, 12:00 AM</DateText>
        <EventText>
