...
export default function Bookings() {
    ...
    // useEffect hook to run script after the component mounts
    useEffect(() => {
        ...
        const isPermitted = (originUrl, whitelisted_domains) => {
            ...
            if (typeof hostname !== 'undefined') {
                whitelisted_domains.forEach((element) => {
                    if (hostname.slice((-1 * element.length - 1)) === '.' + element || hostname === element) {
                        result = true;
                    }
                });
            }
          ...
          <Background>
              <Content>
                  ...
                  <FullWidthImageContainer> 
                    <FullWidthImage src='/images/booking-images/alssc.jpg' alt="Abdul Ladha Science Student Centre" width={1200} height={800} />
                  </FullWidthImageContainer>
                  <br></br>
                  <IntroText>
                  ...
                  <p>Booking Inquiries: <a href="mailto:manager.bookings@sus.ubc.ca"> bmanager.bookings@sus.ubc.ca</a>
                      <br />
                      Operations and Maintenance: <a href="mailto:bmanager.operations@sus.ubc.ca">bmanager.operations@sus.ubc.ca</a>
                  </p>
                </Content>
              <Footer />
          </Background>
